...
* [hoogle (FP Complete)](https://www.fpcomplete.com/hoogle)
...
* [A monad non-tutorial](http://strongtyped.blogspot.jp/2010/01/monad-non-tutorial.html)
* [Haskell Monad Tutorial](http://www.muitovar.com/monad/moncow.xhtml)
* [Haskell/Monad transformers](http://en.wikibooks.org/wiki/Haskell/Monad_transformers)

# Category theory

* [Category theory presentation](http://yannesposito.com/Scratch/en/blog/Category-Theory-Presentation/)
* [Motivating Category Theory for Haskell for Non-mathematicians](http://dekudekuplex.wordpress.com/2009/01/19/motivating-learning-category-theory-for-non-mathematicians/)
...
# Lense & Semantic editor combinators
...
* [Generalized algebraic data type](http://en.wikipedia.org/wiki/Generalized_algebraic_data_type)
* [Haskell/GADT](http://en.wikibooks.org/wiki/Haskell/GADT)
* [Generalised algebraic datatype](http://www.haskell.org/haskellwiki/Generalised_algebraic_datatype)
* [GADTs](http://www.haskellforall.com/2012/06/gadts.html)

# Haskell project APIs

* [Hakyll](http://jaspervdj.be/hakyll/reference/doc-index-All.html)
* [xmonad](http://xmonad.org/xmonad-docs/xmonad/doc-index-All.html)
...
* [Fix your Hackage documentation](http://fuuzetsu.co.uk/blog/posts/2014-01-06-Fix-your-Hackage-documentation.html)
* [Generate and upload docs for hackage packages](https://gist.github.com/stbuehler/7068764)
...
* [1 Haskell A Day exercises](https://github.com/1HaskellADay/1HAD)
...
* [GHC/TypedHoles](http://www.haskell.org/haskellwiki/GHC/TypeHoles)
* [Fold](http://www.haskell.org/haskellwiki/Fold)
* [Monomorphism restriction](http://www.haskell.org/haskellwiki/Monomorphism_restriction)
...
* [Performance/Strictness](http://www.haskell.org/haskellwiki/Performance/Strictness)
* [Church Numerals](https://karczmarczuk.users.greyc.fr/Essays/church.html)
